...
const PaymentInvoiceTemplate = forwardRef<HTMLDivElement, Props>(({ store, data }, ref) => {
...
PaymentInvoiceTemplate.displayName = 'PaymentInvoiceTemplate';
export default PaymentInvoiceTemplate;
